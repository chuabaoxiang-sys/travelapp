...
export const STEP_RINGS_ZH: Record<string, TutorialStepRing> = {
  ...
  'ledger-settle-5': { left: 5.1, top: 79.8, width: 89.7, height: 6.6 },
  'ledger-settle-6': { left: 3.6, top: 61.8, width: 92.8, height: 8.3 },
  'ledger-settle-7': { left: 10.8, top: 40.1, width: 78.5, height: 5 },
  'ledger-settle-8': { left: 3.6, top: 51.8, width: 92.8, height: 48.9 },
  'ledger-settle-9': { left: 79, top: 60.7, width: 13.1, height: 3.5 },
  'ledger-settle-10': { left: 3.6, top: 76.4, width: 92.8, height: 34.8 },
  'budget-1': { left: 6.2, top: 51, width: 87.7, height: 13.1 },
  'budget-2': { left: 71.4, top: 64.8, width: 22.4, height: 3.5 },
  'budget-3': { left: 82.6, top: 68.3, width: 6.2, height: 2.8 },
  'budget-4': { left: 87.7, top: 68.3, width: 6.2, height: 2.8 },
  'wishlist-1': { left: 81.5, top: 91.5, width: 14.9, height: 6.9 },
  'wishlist-2': { left: 15.1, top: 54, width: 69.7, height: 5.5 },
  'wishlist-3': { left: 3.6, top: 38.3, width: 92.8, height: 37.6 },
  'wishlist-4': { left: 72.7, top: 39.9, width: 20.4, height: 4.5 },
  'rates-1': { left: 81.5, top: 91.5, width: 14.9, height: 6.9 },
  'rates-2': { left: 3.6, top: 21.7, width: 92.8, height: 13.2 },
  'rates-3': { left: 5.1, top: 57.6, width: 89.7, height: 12.5 },
  'rates-4': { left: 3.6, top: 18.9, width: 92.8, height: 20.5 },
  'settings-1': { left: 49.2, top: 36.5, width: 44.6, height: 5.5 },
  'settings-2': { left: 45.2, top: 42, width: 48.6, height: 5.5 },
...
export const STEP_RINGS_EN: Record<string, TutorialStepRing> = {
  ...
  'ledger-settle-5': { left: 5.1, top: 78.7, width: 89.7, height: 20.9 },
  'ledger-settle-6': { left: 3.6, top: 61.8, width: 92.8, height: 8.3 },
  'ledger-settle-7': { left: 10.8, top: 40.1, width: 78.5, height: 5 },
  'ledger-settle-8': { left: 3.6, top: 51.8, width: 92.8, height: 48.9 },
  ...
  'budget-1': { left: 6.2, top: 51, width: 87.7, height: 13.1 },
  'budget-2': { left: 55.9, top: 64.8, width: 38, height: 3.5 },
  'budget-3': { left: 82.6, top: 68.3, width: 6.2, height: 2.8 },
  'budget-4': { left: 87.7, top: 68.3, width: 6.2, height: 2.8 },
  'wishlist-1': { left: 81.5, top: 91.5, width: 14.9, height: 6.9 },
  'wishlist-2': { left: 15.1, top: 54.9, width: 69.7, height: 5.5 },
  'wishlist-3': { left: 3.6, top: 38.3, width: 92.8, height: 37.6 },
  'wishlist-4': { left: 70.6, top: 39.9, width: 22.5, height: 4.5 },
  'rates-1': { left: 81.5, top: 91.5, width: 14.9, height: 6.9 },
  'rates-2': { left: 3.6, top: 21.7, width: 92.8, height: 13.2 },
  'rates-3': { left: 5.1, top: 53, width: 89.7, height: 12.5 },
  'rates-4': { left: 3.6, top: 18.9, width: 92.8, height: 22.8 },
  'settings-1': { left: 49.1, top: 31.5, width: 44.8, height: 5.5 },
  'settings-2': { left: 46.9, top: 37.1, width: 47, height: 5.5 },
